...
const staticData = {
    ...
    options: {
      drifter: {
        ...
        skillMod: [{
          ...
          type: 'templateSkill',
          skillKey: 'networking',
          subSkillKey: ['Autonomists', 'Criminals', 'Ecologists', 'Firewall', 'Hypercorps', 'Media', 'Scientists'],
      ...
      lunarColonist: {
        ...
        skillMod: [{
          ...
          type: 'multiple',
          skillKey: ['academic', 'demolitions', 'hardware', 'infosec', 'interfacing', 'medicine', 'profession', 'programming', 'psychosurgery', 'research'],
          mod: 10
        }, {
          type: 'templateSkill',
          skillKey: 'networking',
  ...
  skills: {
    ...
    art: {
      ...
      aptitudeKey: 'int',
      tags: ['Knowledge'],
      options: ['Architecture', 'Criticism', 'Dance', 'Drama', 'Drawing', 'Painting', 'Performance', 'Sculpture', 'Simulspace-Design', 'Singing', 'Speech', 'Writing']
    },
    beamWeapons: {
      label: 'Beam Weapons',
      tags: ['Active', 'Combat'],
    ...
    hardware: {
      ...
      tags: ['Active', 'Technical'],
      aptitudeKey: 'cog',
      options: ['Aerospace', 'Armorer', 'Electronics', 'Groundcraft', 'Implants', 'Industrial', 'Nautical', 'Robotics']
    },
    impersonatoin: {
      label: 'Impersonation',
      tags: ['Active', 'Social'],
    ...
    interest: {
      ...
      tags: ['Knowledge'],
      aptitudeKey: 'cog',
      options: ['Ancient_Sports', 'Celebrity_Gossip', 'Conspiracies', 'Factor_Trivia', 'Gambling', 'Hypercorp_Politics', 'Lunar_Habitats,', 'Martian_Beers', 'Old_Earth_Nation-States', 'Reclaimer_Blogs', 'Science_Fiction', 'Scum_Drug_Dealers', 'Spaceship_Models', 'Triad_Economics', 'Underground_XP']
    },
    interfacing: {
      label: 'Interfacing',
      tags: ['Active', 'Technical'],
    ...
    language: {
      ...
      tags: ['Knowledge'],
      aptitudeKey: 'int',
      options: ['Arabic', 'Bangali', 'Cantonese', 'English', 'French', 'Hindi', 'Japanese', 'Mandarin', 'Portuguese', 'Russian', 'Spanish']
    },
    medicine: {
      label: 'Medicine',
      aptitudeKey: 'cog',
      tags: ['Active', 'Technical'],
      options: ['Biosculpting', 'Exotic-Biomorphs', 'Gene-Therapy,', 'General-Practice', 'Implant-Surgery', 'Nanomedicine', 'Paramedic', 'Pods', 'Psychiatry', 'Remote-Surgery', 'Trauma-Surgery', 'Uplifts', 'Veterinary']
    },
    navigation: {
      label: 'Navigation',
      tags: ['Active', 'Mental'],
    ...
    networking: {
      ...
      tags: ['Active', 'Social'],
      aptitudeKey: 'sav',
      options: ['Autonomists', 'Criminals', 'Ecologists', 'Firewall', 'Hypercorps', 'Media', 'Scientists']
    },
    palming: {
      label: 'Palming',
      tags: ['Active', 'Physical'],
    ...
    pilot: {
      ...
      tags: ['Active', 'Vehicle'],
      aptitudeKey: 'ref',
      options: ['Aircraft', 'Anthroform', 'Exotic-Vehicle', 'Groundcraft', 'Spacecraft', 'Watercraft']
    },
    profession: {
      label: 'Profession',
      tags: ['Knowledge'],
      aptitudeKey: 'cog',
      options: ['Accounting', 'Appraisal', 'Asteroid_Prospecting', 'Banking', 'Cool_Hunting', 'Con_Schemes', 'Distribution', 'Forensics', 'Lab_Technician', 'Mining', 'Police_Procedures', 'Psychotherapy', 'Security_Ops', 'Smuggling_Tricks', 'Social_Engineering', 'Squad_Tactics', 'Viral_Marketing', 'XP_Production']
    },
    programming: {
      label: 'Programming',
      tags: ['Active', 'Technical'],
...
function SimpleField(props) {
  ...
  return /*#__PURE__*/React.createElement("label", null, /*#__PURE__*/React.createElement("p", null, props.label), /*#__PURE__*/React.createElement("input", {
    type: props.type,
    value: props.value,
...
function SimpleDropDown(props) {
  return /*#__PURE__*/React.createElement("label", null, /*#__PURE__*/React.createElement("p", null, props.label), /*#__PURE__*/React.createElement("select", {
    onChange: props.onChange,
    value: props.value
...
function Aptitudes(props) {
  ...
  function updateCP(event, key) {
    ...
    const aptValArray = Object.keys(dynamic.aptitudes).map(aptKey => {
      if (aptKey === key) return parseInt(value, 10);else return parseInt(dynamic.aptitudes[aptKey].value, 10);
    });
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    return /*#__PURE__*/React.createElement("label", {
      ...
      className: "tooltip"
    }, myData.abbreviation, /*#__PURE__*/React.createElement("span", {
      className: "tooltiptext"
    }, myData.name)), /*#__PURE__*/React.createElement("input", {
    ...
    className: "single-aptitude"
  }, /*#__PURE__*/React.createElement("p", null, "Aptitudes"), /*#__PURE__*/React.createElement("p", null, "Base Score"), /*#__PURE__*/React.createElement("p", null, "Sleeve Mod"), /*#__PURE__*/React.createElement("p", null, "Sleeve Max"), /*#__PURE__*/React.createElement("p", null, "Total")));
}
...
function Counter(props) {
  ...
  if (pontsSpent > pontsTotal) Object.assign(style, {
    color: 'red',
    fontWeight: 'bold'
  });
...
class Skills extends React.Component {
  ...
  SimpleSkill(props) {
    ...
    return /*#__PURE__*/React.createElement("label", {
      ...
      className: "skill_cell"
    }, aptMod), /*#__PURE__*/React.createElement("p", {
      className: "skill_cell"
    }, specialMod));
  }
  ...
  TemplateSkill(props) {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("label", {
      ...
      className: "skill_text"
    }, fixedSkill.label, ":"), /*#__PURE__*/React.createElement("select", {
      value: "default",
      onChange: event => props.handleNewSubSkill(event, skillKey)
    }, /*#__PURE__*/React.createElement("option", {
      value: "default"
    }, "Select One"), fixedSkill.options.map(option => {
      return /*#__PURE__*/React.createElement("option", {
        value: option,
        key: ['option', skillKey, option].join('_')
      }, option);
    }))), /*#__PURE__*/React.createElement("p", {
      className: "skill_cell"
    }, fixedSkill.aptitudeKey.toUpperCase()), /*#__PURE__*/React.createElement("p", {
      ...
      return /*#__PURE__*/React.createElement(this.SimpleSkill, {
    ...
    const totalValues = skillKey => {
      if (characterSkills[skillKey]) {
        ...
        if ('number' === typeof mySkill) {
          ...
          return Object.keys(mySkill).map(subSkillKey => {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("section", {
      ...
      className: "skill_cell"
    }, "Aptitude"), /*#__PURE__*/React.createElement("p", {
      className: "skill_cell"
    }, "Total"), /*#__PURE__*/React.createElement("p", {
      className: "skill_cell"
    }, "Ranks"), /*#__PURE__*/React.createElement("p", {
      className: "skill_cell"
...
class CharacterSheet extends React.Component {
  ...
  handleBackground(data) {
    ...
    skillMod.forEach(option => {
      ...
      const fixedSkill = this.staticData.skills[skillKey]; //if the skill 

      if (fixedSkill.options) {
        const subSkillKey = option.selection; //if the character does not have the currnent option's skill
  ...
  handleInputChange(event, ...keys) {
    const isNum = parseInt(event.target.value, 10); // const isObj = JSON.parse(event.target.value);

    let value = event.target.value;
    if (isNum || isNum === 0) value = isNum; // else if (isObj) value = isObj;
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Counter, {
      ...
      if (item.type === 'text') {
        return /*#__PURE__*/React.createElement(SimpleField, {
          type: item.type,
          label: item.label,
        ...
        return /*#__PURE__*/React.createElement(SimpleDropDown, {
          label: item.label,
    ...
    }, "Report"), /*#__PURE__*/React.createElement("br", null));
  }
